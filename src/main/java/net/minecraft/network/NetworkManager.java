...
public class NetworkManager extends SimpleChannelInboundHandler<Packet>
{
    ...
    {
        if (!noEvent) {
            PacketEvent event = new PacketEvent(PacketEvent.Type.SEND, packetIn, this.packetListener);
            if (direction == CLIENTBOUND) Faiths.INSTANCE.getEventManager().callEvent(event);
