...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    private PlayerDataSamples playerDataSamples;
    ...
    public EntityPlayer(World worldIn, GameProfile gameProfileIn)
    {
        ...
        this.playerDataSamples = new PlayerDataSamples();
    }

    public PlayerDataSamples getPlayerDataSamples() {
        return playerDataSamples;
    }
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag2)
                    {
                        if (i > 0)
                        {
                            ...
                            if(!Faiths.moduleManager.getModule("KeepSprint").getState()){
                                this.motionX *= 0.6D;
                                this.motionZ *= 0.6D;
