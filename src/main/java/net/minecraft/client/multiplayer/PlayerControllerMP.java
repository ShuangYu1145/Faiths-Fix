...
import dev.faiths.event.impl.ClickWindowEvent;
...
public class PlayerControllerMP
{
    ...
    {
        Faiths.INSTANCE.getEventManager().callEvent(new AttackEvent(targetEntity));
        this.syncCurrentPlayItem();
    ...
    {
        ClickWindowEvent clickWindowEvent = new ClickWindowEvent();
        Faiths.INSTANCE.getEventManager().callEvent(clickWindowEvent);
