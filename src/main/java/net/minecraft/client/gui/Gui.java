...
public class Gui
{
     ...
     */
    public static void drawModalRectWithCustomSizedTexture(final float x, final float y, float u, float v, final float width, final float height, float textureWidth, float textureHeight)
    {
