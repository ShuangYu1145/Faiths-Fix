...
public class ModulePotionHUD extends CheatModule {
    ...
    float lerpSpeed = 0.01F; // 插值速度，可根据需要调整
    float tempYPos = 0F;
    float tempWidth = 0F;
    ...
    public void draw() {
        ...
        RoundedUtil.drawRound(-20, -10, tempWidth + 5, currentHeight, 4 ,new Color(0, 0, 0, globalalpha.getValue()));
        ShaderElement.addBlurTask(() ->  RoundedUtil.drawRound(xValue.getValue() - 20, yValue.getValue() -10, tempWidth + 5, currentHeight, 4 ,new Color(0, 0, 0)));
        ShaderElement.addBloomTask(() ->  RoundedUtil.drawRound(xValue.getValue() - 20, yValue.getValue() - 10, tempWidth + 5, currentHeight, 4 ,new Color(0, 0, 0)));
