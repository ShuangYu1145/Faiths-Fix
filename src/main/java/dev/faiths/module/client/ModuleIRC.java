...
import dev.faiths.utils.irc.TypeMap;
        ...
        public static void startIRCThread() {
            Thread ircThread = new Thread(() -> {
                try {
                    ...
                    TypeMap.Type();
                    writer.println(".serverusernames"  +  "§f[§e"  + TypeMap.Type +"§f] §f" + mc.thePlayer.getName() + "§7(§b§l" + mc.thePlayer.getName() + "§7)§f" +  "§7(§b§l" + Faiths.NAME + " TEST§7)§f");//自己选择Type添加的位置 TypeMap.Type
                    startIRCChatThread();
